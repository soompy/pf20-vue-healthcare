  ...
  <div class="card">
    ...
    >
      ...
      <div class="readmore">
        ...
        <p>
          이왕이면 왼쪽으로 누워 자자. 위 건강에 좋다. 위는 왼쪽으로 부푼 자루
          모양이다. 그래서 왼쪽으로 누우면 위가 원래 모양대로 자연스럽게 아래로
          처진다. 반대로 오른쪽으로 누우면 자루 모양으로 부푼 쪽이 천장을 향하기
          때문에 위산이 식도로 역류할 수 있다. 왼쪽으로 누워 자면 심장에도 좋다.
          심장은 왼쪽에 있어서 왼쪽으로 누워 잘 때 심장이 더 편하게 일할 수 있고
          혈액순환도 더 잘된다. 코를 고는 사람은 왼쪽이든 오른쪽이든 옆으로 누워
          자야 코골이가 줄어든다. 단, 허리디스크가 있다면 똑바로 누워 자는 게
          좋다.
        </p>
        <h3>HABIT 02. 목마르지 않아도 물 마시기</h3>
        <p>
          이유 없이 피곤하다, 무기력하다, 기운이 없다, 일어날 때 핑 돈다 등
          겨울철에 유독 이런 증상이 나타난다면 탈수증일 수 있다. 탈수증은 땀을
          많이 흘리는 여름에만 생기는 게 아니다. 오히려 겨울에 더 생긴다. 땀이
          안 나고 덥지 않아서 물을 안 마시게 되기 때문. 특히 나이가 들면 갈증을
          느끼는 감각이 무뎌져 물을 더 안 마시게 된다. 갈증이 느껴지면 이미
          늦는다. 시간을 정해놓고 목이 마르지 않아도 습관적으로 물을 마시자.
          그래야 신진대사가 잘되어서 노폐물이 쌓이지 않고 피로도 금방 회복된다.
        </p>
        <h3>HABIT 03. 양반다리 말고 다리 뻗고 건방지게 앉기</h3>
        <p>
          책상다리로 앉아 있다가 일어서면 저절로 ‘아이쿠’ 소리가 난다. 이 자세는
          한쪽 다리는 위로, 반대쪽 다리는 아래로 포개놓는 비대칭적인 자세라서
          골반부터 고관절, 무릎, 발목 등 하체 관절 전체에 부담이 간다. 많이
          걸어야만 무릎관절이 닳는 게 아니다. 책상다리로 앉으면 서 있을 때보다
          무릎에 하중이 더 많이 실린다. 앉아만 있었는데도 무릎 연골이 손상되어
          퇴행성관절염이 나타날 수 있다. 또한 책상다리로 앉으면 허리도 세울 수
          없다. 허리의 C 자 커브가 무너져서 척추 건강에 치명적이다. 바닥에
          앉아야 한다면 등을 벽에 기대고 다리를 앞으로 뻗고 앉는다.
        </p>
        <h3>HABIT 04. 뜨거운 국물 먹으면 입안 헹구기</h3>
        <p>
          한국인의 나트륨 섭취량이 세계보건기구(WHO) 권장량의 두 배가 넘는다는
          것은 잘 알려진 사실. 가장 큰 원인은 국물 요리에 있다는 것도 잘 알고
          있다. 여기에 ‘뜨거운’까지 더해지면 치아와 잇몸 질환까지 생긴다. 뜨거운
          국물 요리를 먹으면 잇몸이 붓고 치아 표면에 기름기가 달라붙어 충치나
          치주염을 일으키기 쉬운 상태가 되는 것. 음식 온도가 50℃가 넘으면 치아에
          미세하게 균열이 생겨 치아가 시릴 수 있다. 뜨거운 국물 요리를 먹었다면
          곧바로 미지근한 물로 입안을 헹군다.
        </p>
        <h3>HABIT 05. 운동은 ‘빡’세고 힘들게!</h3>
        <p>
          운동은 약하게 오래 하는 것보다 강하게 짧게 하는 것이 더 효과적이라는
          연구 결과가 많다. 예를 들어 러닝머신에서 걷는다면 경사를 높이는 게
          좋다. 에너지 소모량이 60%까지 증가한다. 땅 위에서 걸으면 러닝머신에서
          걷는 것보다 에너지 소모량이 10% 이상 증가하는데 여기에 팔꿈치를 90도로
          구부리고 앞뒤로 흔들며 보폭을 넓게 걸으면 에너지 소모량이 15%
          향상된다. 덤벨을 들고 근육 운동을 할 때도 부상의 위험이 없다면 더
          무거운 걸 들자. 5kg짜리 덤벨을 열 번 드는 것보다 10kg짜리 덤벨을 다섯
          번 드는 게 에너지 소모량이 25% 더 많다. 무엇보다 심폐지구력은 약하게
          오래 운동하는 것보다 강하게 짧게 할 때 더 좋아진다. 심폐지구력이
          좋아져야 지방을 잘 태우는 몸이 된다.
        </p>
      </div>
    </div>

    <div class="articlemeta" v-if="isAddClass">
      <ul class="left">
