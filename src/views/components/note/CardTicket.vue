<template>
  <div class="flex">
    <div class="card">
      ...
      <div class="content" v-on:click="addClass" :class="{'full': isAddClass}" @close="closeContent">
        ...
        <div class="closebar">
          <h1>오늘의 건강 뉴스</h1>
          <a class="closebttn" @click="$emit('close')"><i class="material-icons">&#xE5CD;</i></a>
        </div>
...
<!--        <a href="#0" class="readmore" v-on: click="addClass" : class="{'myClass': isAddClass}" ></a>-->
<!--      </div>-->
<!--    </div>-->
<!--  </div>-->
